...
namespace Auth.Migrations.Migrations
{
    ...
    [Migration("20260510135422_AddPreferredNotificationMethods")]
    partial class AddPreferredNotificationMethods
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Auth.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("PreferredNotificationMethods")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
