...
The **ProLanguage** is a web-based system designed to facilitate the management and operation of an online English language school. It supports features for students, teachers, administrators, and general users. The website allows for efficient scheduling, course management, communication, and monitoring of student progress. It also includes a secure authentication system, multi-role authorization, and UI designed for both learners and educators.
...
- **Unit Testing**: The website includes unit tests to ensure backend reliability and correctness.
...
- **Multi-language Support**: The website supports multiple languages via localization features.
...
|------|-----------|------------------|----------------------------------|
| 1.   | Admin Panel with Services | Implement an admin panel for managing the website. | [prolanguage-epic-01](epic-01.md) |
| 2.   | Headers and Unit Testing | Implement proper headers and unit tests for API endpoints. | [prolanguage-epic-02](epic-02.md) |
| 3.   | Logging and Swagger | Add structured logging and API documentation with Swagger. | [prolanguage-epic-03](epic-03.md) |
| 4.   | Enhancements and UI Integration | Improve UI elements and overall user experience. | [prolanguage-epic-04](epic-04.md) |
| 5.   | Payment Methods | Extend functionality by adding payment gateway support. | [prolanguage-epic-05](epic-05.md) |
| 6.   | Authorization | Implement role-based access control for different user types. | [prolanguage-epic-06](epic-06.md) |
| 7.   | Filters | Implement course filtering and pagination features. | [prolanguage-epic-07](epic-07.md) |
| 8.   | Comments and Moderation | Add user comments and content moderation features. | [prolanguage-epic-08](epic-08.md) |
| 9.   | Course Picture [Microsoft Azure] | Enable course image uploads and display them on course details pages. | [prolanguage-epic-9](epic-9.md) |
| 10.  | AI Tutor Implementation | Add AI Tutor to the web project | [prolanguage-epic-10](epic-10.md) |
...
| 13.  | UI Design [Angular] | Apply UI designs based on given mock-ups. | [prolanguage-epic-13](epic-13.md) |
